  ...
  return (
    <div style={{marginTop:'100px'}}>
      <div style={{ position: 'relative' }}>
        ...
        {showForm && (
          <Container
            style={{ border: '1px solid #ccc', padding: '10px', marginTop: '20px', width: '330px', marginTop: '-10px', background: '#e6fff7', height: '330px', marginLeft:'100px' }}
          >
      ...
      {submittedTasks.length > 0 && (
        <div style={{  padding: '10px', marginTop: '20px' }}>
          <ul style={{ listStyleType: 'none', padding: 0, width:'340px',marginLeft:'90px',marginTop: '-29px' }}>
            {submittedTasks.map((task, index) => (
              <li key={index} style={{ border: '1px solid #ccc', padding: '10px',marginRight:'10px' }}>
                <Row style={{marginLeft:'20px'}}>{task.description}</Row>
                <Row style={{marginLeft:'20px'}}>{task.date}</Row>
                <Col style={{marginRight:'20px'}}><button onClick={() => handleEdit(task)}>Edit</button></Col>
              </li>
